...
/// A simple Swift wrapper for NSTimer. Use it just as you would NSTimer with the exectpion that your provide a closure to perform when the timer fires instead of a method selector.
